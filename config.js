...
window.RMVS_CONFIG = {
  ...
  // URL of the Reflective MVS Substack RSS feed. This will be used to populate
  // a dedicated Substack card with your latest newsletter posts. Update this
  // value if your feed URL changes or you want to pull a different feed.
  substackFeed: "https://reflectivemvs.substack.com/feed",
